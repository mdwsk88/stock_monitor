...
public class AStockTool {
     ...
     * 根据股票代码查询A股信息
     */
    @Tool(description = "根据股票代码查询A股股票信息数据，如：000001、600000")
     ...
     * 根据股票代码和日期范围查询A股信息
     */
    @Tool(description = "根据股票代码查询某段日期范围内的A股股票信息数据，日期格式：yyyy-MM-dd")
     ...
     */
    @Tool(description = "查询某日期段内的哪些A股股票出现的次数超过指定的目标次数")
     ...
     * 根据标题关键字查询A股信息
     */
    @Tool(description = "根据标题关键字来查询A股股票信息数据")
     ...
     * 根据股票名称关键字查询A股信息
     */
    @Tool(description = "根据股票名称关键字来查询A股股票信息数据")
